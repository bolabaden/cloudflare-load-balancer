/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ebde066db3e324613d2e225d4375996c)
// Runtime types generated with workerd@1.20250730.0 2025-06-05 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		API_SECRET: "bc0d037f84a54300811498e705716b6ed601f52209524a06b1eaa668904f60bc";
		DEBUG: "true";
		DEFAULT_BACKENDS: "{\"services\":[{\"hostname\":\"(.+)\\\\.bolabaden\\\\.org\",\"backends\":[\"https://$1.micklethefickle.bolabaden.org\",\"https://$1.vractormania.bolabaden.org\",\"https://$1.beatapostapita.bolabaden.org\",\"https://$1.arnialtrashlid.bolabaden.org\",\"https://$1-koyeb.bolabaden.org\",\"https://$1-render.bolabaden.org\",\"https://$1-railway.bolabaden.org\",\"https://$1-flyio.bolabaden.org\",\"https://$1-vercel.bolabaden.org\"]}]}";
		DNS_FIRST: "true";
		...
		SSL_SKIP_CERTIFICATE_VERIFICATION: "true";
		SSL_ALLOW_SELF_SIGNED_CERTIFICATES: "true";
		SSL_SKIP_HOSTNAME_VERIFICATION: "true";
		FORCE_ENV: "true";
		LOAD_BALANCER_DO: DurableObjectNamespace<import("./src/index").LoadBalancerDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_SECRET" | "DEBUG" | "DEFAULT_BACKENDS" | "DNS_FIRST" | "DNS_FIRST_TIMEOUT_MS" | "DNS_FIRST_FAILURE_STATUS_CODES" | "DNS_FIRST_MAX_RESPONSE_TIME_MS" | "SSL_SKIP_CERTIFICATE_VERIFICATION" | "SSL_ALLOW_SELF_SIGNED_CERTIFICATES" | "SSL_SKIP_HOSTNAME_VERIFICATION" | "FORCE_ENV">> {}
}
